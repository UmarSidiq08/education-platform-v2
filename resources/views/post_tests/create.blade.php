...
@section('content')
    ...
    <body class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
        <div class="container mx-auto px-2 sm:px-4 py-4 sm:py-8 max-w-6xl">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-200">
                <div class="p-4 sm:p-6 lg:p-8">
                    <form action="{{ route('post_tests.store', $class) }}" method="POST" id="postTestForm" enctype="multipart/form-data">
                        @csrf
                        <!-- Basic Information -->
                        <div class="mb-6 sm:mb-8">
                            <h3
                                class="text-lg sm:text-xl font-bold text-gray-800 mb-4 sm:mb-6 pb-3 border-b border-gray-200">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                                ...
                                <div class="lg:col-span-2">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Masukkan judul post test yang menarik..." required>
                                </div>
                                ...
                                <div class="lg:col-span-2">
                                    ...
                                    <textarea
                                        class="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
                                        id="description" name="description" rows="3" placeholder="Berikan deskripsi singkat tentang post test ini..."></textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="number"
                                            ...
                                            id="time_limit" name="time_limit" value="30" min="1" required>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="number"
                                            class="w-full px-3 sm:px-4 py-2 sm:py-3 pr-10 sm:pr-12 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
                                            id="passing_score" name="passing_score" value="80" min="1"
                                            max="100" required>
                                        <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                        ...
                        <div class="mb-6 sm:mb-8">
                            <div
                                class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 sm:mb-6 pb-3 border-b border-gray-200 space-y-3 sm:space-y-0">
                        ...
                        <!-- Action Buttons -->
                        <div
                            class="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-between pt-4 sm:pt-6 border-t border-gray-200">
        ...
        <template id="question-template">
            <div
                class="question-card bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl">
                ...
                <div class="p-4 sm:p-6">
                    ...
                    <div class="mb-4 sm:mb-6">
                        ...
                        <textarea
                            class="question-text w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
                            name="questions[0][question]" rows="3" placeholder="Tulis pertanyaan Anda di sini..." required></textarea>
                    </div>
                    ...
                    <div class="mb-4 sm:mb-6">
                        ...
                        <div class="flex flex-col gap-3">
                            <div class="relative">
                                <input type="file" name="questions[0][image]" accept="image/*"
                                    class="hidden image-input" id="image-0" onchange="previewImageCreate(this, 0)">
                                <label for="image-0"
                                    class="flex items-center justify-center gap-2 p-4 border-2 border-dashed border-blue-200 rounded-lg cursor-pointer hover:border-blue-400 hover:bg-blue-50 transition-all duration-300">
                            ...
                            <div id="preview-0" class="hidden">
                                <div class="relative inline-block">
                                    <img src="" alt="Preview"
                                        class="max-w-full h-auto rounded-lg border-2 border-blue-100 max-h-64">
                                    <button type="button" onclick="removeImageCreate(0)"
                    ...
                    <div class="mb-4 sm:mb-6">
                        ...
                        <div class="relative w-24 sm:w-32">
                            <input type="number"
                                ...
                                name="questions[0][points]" value="1" min="1" required>
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-semibold text-gray-700 mb-3">
                            ...
                            <span class="block sm:inline text-xs text-gray-500 font-normal sm:ml-2 mt-1 sm:mt-0">(Klik
                                radio button untuk menandai jawaban yang benar)</span>
                        </label>
                        ...
                        <div class="options-container space-y-3">
                            ...
                            <div class="option-item">
                                <div
                                    class="flex flex-col sm:flex-row items-start sm:items-center justify-between p-3 border border-gray-200 rounded-lg hover:border-blue-300 transition-colors duration-300 option-container">
                                    <div class="flex items-center w-full sm:w-auto sm:flex-1">
                                        <div class="flex-shrink-0 mr-3">
                                            <span
                                                class="inline-flex items-center justify-center w-6 sm:w-8 h-6 sm:h-8 bg-blue-100 text-blue-800 rounded-full font-semibold text-xs sm:text-sm">A</span>
                                        </div>
                                        <input type="text"
                                            ...
                                            name="questions[0][options][0]" placeholder="Masukkan pilihan jawaban A..."
                                            required>
                                    </div>
                            ...
                            <div class="option-item">
                                <div
                                    ...
                                    <div class="flex items-center w-full sm:w-auto sm:flex-1">
                                        <div class="flex-shrink-0 mr-3">
                                            <span
                                                class="inline-flex items-center justify-center w-6 sm:w-8 h-6 sm:h-8 bg-blue-100 text-blue-800 rounded-full font-semibold text-xs sm:text-sm">B</span>
                                        </div>
                                        <input type="text"
                                            class="option-input px-2 sm:px-3 py-1 sm:py-2 text-sm sm:text-base border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
                                            name="questions[0][options][1]" placeholder="Masukkan pilihan jawaban B..."
                                            required>
                                    </div>
                                    <div class="flex-shrink-0 mt-2 sm:mt-0 sm:ml-4 pl-9 sm:pl-0">
                                        <label class="inline-flex items-center">
                            ...
                            <div class="option-item">
                                <div
                                    ...
                                    <div class="flex items-center w-full sm:w-auto sm:flex-1">
                                        <div class="flex-shrink-0 mr-3">
                                            <span
                                                class="inline-flex items-center justify-center w-6 sm:w-8 h-6 sm:h-8 bg-blue-100 text-blue-800 rounded-full font-semibold text-xs sm:text-sm">C</span>
                                        </div>
                                        <input type="text"
                                            class="option-input px-2 sm:px-3 py-1 sm:py-2 text-sm sm:text-base border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
                                            name="questions[0][options][2]" placeholder="Masukkan pilihan jawaban C..."
                                            required>
                                    </div>
                                    <div class="flex-shrink-0 mt-2 sm:mt-0 sm:ml-4 pl-9 sm:pl-0">
                                        <label class="inline-flex items-center">
                            ...
                            <div class="option-item">
                                <div
                                    ...
                                    <div class="flex items-center w-full sm:w-auto sm:flex-1">
                                        <div class="flex-shrink-0 mr-3">
                                            <span
                                                class="inline-flex items-center justify-center w-6 sm:w-8 h-6 sm:h-8 bg-blue-100 text-blue-800 rounded-full font-semibold text-xs sm:text-sm">D</span>
                                        </div>
                                        <input type="text"
                                            class="option-input px-2 sm:px-3 py-1 sm:py-2 text-sm sm:text-base border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
                                            name="questions[0][options][3]" placeholder="Masukkan pilihan jawaban D..."
                                            required>
                                    </div>
                                    <div class="flex-shrink-0 mt-2 sm:mt-0 sm:ml-4 pl-9 sm:pl-0">
                                        <label class="inline-flex items-center">
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function addQuestion() {
                    ...
                    [...textareas, ...inputs, ...selects].forEach(element => {
                        if (element.name) {
                            element.name = element.name.replace(/questions\[\d+\]/g,
                                `questions[${questionCount}]`);
                        }
                    });

                    // Update image input IDs and attributes
                    ...
                    if (imageInput && imageLabel && previewDiv) {
                        ...
                        imageInput.setAttribute('onchange', `previewImageCreate(this, ${questionCount})`);

                        const removeBtn = previewDiv.querySelector('button');
                        if (removeBtn) {
                            removeBtn.setAttribute('onclick', `removeImageCreate(${questionCount})`);
                        }
                    }
                ...
                function updateQuestionNumbers() {
                    document.querySelectorAll('.question-card').forEach((card, index) => {
                        ...
                        if (imageInput && imageLabel && previewDiv) {
                            ...
                            imageInput.setAttribute('onchange', `previewImageCreate(this, ${index})`);

                            const removeBtn = previewDiv.querySelector('button');
                            if (removeBtn) {
                                removeBtn.setAttribute('onclick', `removeImageCreate(${index})`);
                            }
                        }
                    });
                ...
                function showAlert(message, type = 'info') {
                    ...
                    alertDiv.className =
                        `fixed top-4 right-2 sm:right-4 left-2 sm:left-auto ${bgColor} text-white px-4 sm:px-6 py-3 sm:py-4 rounded-lg shadow-lg z-50 transform translate-x-full transition-transform duration-300 text-sm sm:text-base`;
                    alertDiv.innerHTML = `
        ...
        `;
                ...
                document.getElementById('postTestForm').addEventListener('submit', function(e) {
                    ...
                    imageInputs.forEach((input, index) => {
                        if (input.files && input.files[0]) {
                            ...
                            if (file.size > maxSize) {
                                isValid = false;
                                errorMessages.push(
                                    `Pertanyaan ${questionNum}: File "${file.name}" terlalu besar (${(file.size / 1024 / 1024).toFixed(2)} MB). Maksimal 2 MB.`
                                    );
                            }
                            ...
                            if (!allowedTypes.includes(file.type)) {
                                isValid = false;
                                errorMessages.push(
                                    `Pertanyaan ${questionNum}: Format file "${file.name}" tidak didukung. Gunakan JPG, JPEG, PNG, atau GIF.`
                                    );
                            }
                        }
                    });
                    ...
                    questionCards.forEach((card, index) => {
                        ...
                        const correctAnswer = card.querySelector(
                            `input[name="questions[${index}][correct_answer]"]:checked`);
                        ...
                        if (!correctAnswer) {
                            isValid = false;
                            errorMessages.push(
                                `Pertanyaan #${index + 1} belum memiliki jawaban yang benar`);
                        }
                    });
            ...
            function previewImageCreate(input, questionNum) {
            ...
            function removeImageCreate(questionNum) {

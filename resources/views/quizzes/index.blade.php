            ...
            @if ($quizzes->count() > 0)
                ...
                @if ($activeQuiz)
                    ...
                    <div class="stats-grid">
                        ...
                        <div class="stat-card">
                            <h3 class="stat-value success">
                                {{ $activeQuiz->attempts->avg('percentage') ? round($activeQuiz->attempts->avg('percentage'), 1) : 0 }}%
                            </h3>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="progress-container">
                                                    <div class="progress-bar" style="width: {{ $attempt->percentage }}%">
                                                    </div>
                                            ...
                                            <td>
                                                <span
                                                    class="timestamp">{{ $attempt->finished_at->format('d/m/Y H:i') }}</span>
                                            </td>
                                            <td>
                            ...
                            @foreach ($activeQuiz->questions as $index => $question)
                                @php
                                    ...
                                    foreach ($activeQuiz->attempts as $attempt) {
                                        $userAnswer = isset($attempt->answers[$question->id])
                                    ...
                                    $correctPercentage =
                                        $totalAttempts > 0 ? round(($correctCount / $totalAttempts) * 100) : 0;
                                @endphp
                                ...
                                <div class="question-analysis">
                                    <div class="question-header">
                                        ...
                                        <span
                                            class="correct-percentage {{ $correctPercentage >= 80 ? 'success' : ($correctPercentage >= 60 ? 'warning' : 'danger') }}">
                                    ...
                                    <div class="question-progress">
                                        ...
                                        <div class="progress-info">
                                            <span>{{ $correctCount }} dari {{ $totalAttempts }} siswa menjawab dengan
                                                benar</span>

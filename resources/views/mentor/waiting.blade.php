...
<body class="gradient-bg min-h-screen flex items-center justify-center p-3 sm:p-4 relative overflow-hidden">
    ...
    <!-- Main Content -->
    <div class="w-full max-w-sm sm:max-w-lg relative z-10">
        <!-- Main Card -->
        <div class="glass-effect rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-2xl text-center">
            <!-- Animated Clock Icon -->
            <div class="relative mb-6 sm:mb-8">
                <div
                    class="pulse-animation inline-flex items-center justify-center w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full shadow-lg">
            ...
            <!-- Subtitle -->
            <div
                class="bg-gradient-to-r from-indigo-500 to-purple-600 bg-clip-text text-transparent font-semibold text-base sm:text-lg mb-5 sm:mb-6">
                Akun Mentor Anda Sedang Diproses
            </div>

            <!-- Description -->
            <p class="text-gray-600 text-sm sm:text-base leading-relaxed mb-6 sm:mb-8 px-1 sm:px-2">
            ...
            <div class="mb-6 sm:mb-8 space-y-3 sm:space-y-4">
                <div class="flex items-center">
                    <div
                        class="w-7 h-7 sm:w-8 sm:h-8 bg-green-500 rounded-full flex items-center justify-center text-white text-xs sm:text-sm font-bold flex-shrink-0">
                        ✓
                    </div>
                ...
                <div class="flex items-center">
                    <div class="w-7 h-7 sm:w-8 sm:h-8 bg-yellow-500 rounded-full flex items-center justify-center text-white flex-shrink-0">
                ...
                <div class="flex items-center">
                    <div
                        class="w-7 h-7 sm:w-8 sm:h-8 bg-gray-300 rounded-full flex items-center justify-center text-gray-500 text-xs sm:text-sm flex-shrink-0">
                        3
                    </div>
                    <div class="ml-3 text-left flex-1">
            ...
            <!-- Info Box -->
            <div class="bg-blue-50 border border-blue-200 rounded-xl p-3 sm:p-4 mb-6 sm:mb-8">
                <div class="flex items-start space-x-2 sm:space-x-3">
                    <svg class="w-4 h-4 sm:w-5 sm:h-5 text-blue-500 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                        <path
            ...
            <div class="space-y-3 sm:space-y-4">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit"
                        class="btn-hover w-full bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-semibold py-3 sm:py-4 px-5 sm:px-6 rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 shadow-lg inline-flex items-center justify-center space-x-2 text-sm sm:text-base">
                ...
                <button
                    class="w-full bg-white border-2 border-gray-200 hover:border-indigo-300 text-gray-700 hover:text-indigo-600 font-medium py-3 px-5 sm:px-6 rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 inline-flex items-center justify-center space-x-2 text-sm sm:text-base">
                    <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
                        <path
        ...
        <div class="mt-4 sm:mt-6 text-center">
            <p class="text-white/80 text-xs sm:text-sm px-2">
